/*
  ...
  - Made the column `createdAt` on table `MyBlog` required. This step will fail if there are existing NULL values in that column.
  - Made the column `updatedAt` on table `MyBlog` required. This step will fail if there are existing NULL values in that column.
  - Made the column `createdAt` on table `MySkills` required. This step will fail if there are existing NULL values in that column.
  - Made the column `updatedAt` on table `MySkills` required. This step will fail if there are existing NULL values in that column.
  - Made the column `createdAt` on table `AboutMe` required. This step will fail if there are existing NULL values in that column.
  - Made the column `updatedAt` on table `AboutMe` required. This step will fail if there are existing NULL values in that column.
  - Made the column `createdAt` on table `MyProject` required. This step will fail if there are existing NULL values in that column.
  - Made the column `updatedAt` on table `MyProject` required. This step will fail if there are existing NULL values in that column.
  - Made the column `createdAt` on table `MyByography` required. This step will fail if there are existing NULL values in that column.
  - Made the column `updatedAt` on table `MyByography` required. This step will fail if there are existing NULL values in that column.
  ...
  - Made the column `createdAt` on table `MyExperience` required. This step will fail if there are existing NULL values in that column.
  - Made the column `updatedAt` on table `MyExperience` required. This step will fail if there are existing NULL values in that column.
  - Made the column `createdAt` on table `MyContacts` required. This step will fail if there are existing NULL values in that column.
  - Made the column `updatedAt` on table `MyContacts` required. This step will fail if there are existing NULL values in that column.
